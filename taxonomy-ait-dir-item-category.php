		...
		{first}<ul class="items">{/first}
			<li class="item clear{ifset $item->packageClass} {$item->packageClass}{/ifset}">
                ...
                {if (is_iphone($version))}
                    ...
                    <a href="comgooglemaps://?daddr={!$item->optionsDir['address']}" class="google button">Google Maps</a>

                    {else}

                    {if (is_ipad($version))}	
                        
                        <a href="comgooglemaps://?daddr={!$options['address']}" class="google button">Google Maps</a>
